...
session_start();
define('TITLE', 'New Parameter Group');
...
{
	if (!empty($_POST['gcde']) and !empty($_POST['gname']) )	
...
*/
		//and isset($_POST['did']) 
			$q = "insert into eleg (gcde,gname,avg_tp) 
						values ('".$_POST['gcde']."','".$_POST['gname']."','".$_POST['gavtp']."');";
...
print '
<form onsubmit="submitForm()" action="egp_new.php" method="post">
			<p style="text-align:center;font-size:28px;color:blue;font-weight:bold;">New Parameter Group</p>
...
print '</td></tr>
			<tr style="color:#555555;">
				...
				<td>
				  <input style="margin-left:10px" type="text" name="gcde" id="gcde"></input>
				</td>				 	
			</tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
					<label for="sname">Group Name</label>
				</td>
				<td>
				  <input style="margin-left:10px" type="text" name="gname" id="gname"></input>
				</td>				 	
			</tr>													
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
					<label for="sname">Average Type</label>
				</td>
				<td>
				  <input style="margin-left:10px" type="text" name="gavtp" id="gavtp"></input>
				</td>				 	
			</tr>													
