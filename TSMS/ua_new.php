...
{
	if (!empty($_POST['uid']) and !empty($_POST['ronly']) and !empty($_POST['pwd']) and !empty($_POST['fname']) and !empty($_POST['lname']) )	
		//if (isset($_POST['userid']) and isset($_POST['fname']) and isset($_POST['lname']) and isset($_POST['pwd']))	
	{
			$q = "insert into uacc (uid,pwd,fname,lname,ronly) 
						values ('".$_POST['uid']."','".$_POST['pwd']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['ronly']."');";
...
<form onsubmit="submitForm()" action="ua_new.php" method="post">
			<p style="text-align:center;font-size:28px;color:blue;font-weight:bold;">New User Account</p>
...
print '</td></tr>
			<tr style="color:#555555;">
				...
				<td>
				  <input style="margin-left:10px" type="text" name="uid" id="uid"></input>
				</td>				 	
			</tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
