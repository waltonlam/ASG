...
print '<hr>
	<div class="topnav">
	<a href="imp.php">New Data Template Input</a>
	<a href="loc_new.php">Add New Location</a>
	<a href="update_loc_m.php">Edit Location</a>
	<a href="del_loc.php">Delete Location</a>
	<a href="egp_new.php">Add New Parameter Group</a>
	<a href="update_gp_m.php">Edit Parameter Group</a>
	<a href="del_gp.php">Delete Parameter Group</a>
	<a href="ele_new.php">Add New Parameter</a>
	<a href="update_ele_m.php">Edit Parameter</a>
	<a href="del_ele.php">Delete Parameter</a>
	</div><hr>';
...
if (!empty($_POST['to_date'])){
 ...
 if ($result_g->num_rows){ 
	...
	//print '<td><input type="checkbox" name="'.$r_ele["ele_id"].'" value="'.$r_ele["ele_id"].'">'.$r_ele["name"].'</td>';
		//print '<td><input type="checkbox" name="loc_id[]" value="'.$r_loc["loc_id"].'">'.$r_loc["name"].'</td>';
		print '<option value="'.$r_g["gcde"].$r_g["avg_tp"].'">'.$r_g["gname"].'</option>';
		//print '<option value="'.$g_no_l.'">'.$r_g["gname"].'</option>';

		++$g_no_l;
	}								 
	//print '</tr></div>
	print '</tr><p>Selected Group: '.substr($_POST["EG"],0,3).' / Average Type: '.substr($_POST["EG"],3).'</p>';
	print '</select><noscript><input type="submit" value="Submit"></noscript>';
