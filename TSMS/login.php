...
//else { // Display the form.
	...
	<p align="center" style="margin-right:18px"><font size="5">Username:<input type="text" name="uid" size="20" dir="ltr" style="margin-left: 8px;"></br>
	<p align="center" style="margin-right:18px"><font size="5">Password:<input type="password" name="pwd" size="20" dir="ltr" style="margin-left: 8px;"></p>
	<p align="center"><input type="submit" name="submit" value="Submit" class="button--general"></p>
	</form>';
