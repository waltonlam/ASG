...
*/							
print '
<form action="del_kb_m.php" method="post">
			<p style="text-align:center;font-size:28px;color:blue;font-weight:bold;">街站資料刪除</p>
      
      <table style="width:92%;margin-left:2%;">
		  <input style="margin-left:10px" type="hidden" name="kid" id="kid" value='.$t[1].'></input>			
