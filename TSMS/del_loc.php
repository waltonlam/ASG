	...
	if (!empty($_POST['lid']))	
		{
				...
				$u="select * from sample_ele" ." where loc_id='".$_POST['lid']."' limit 1";
				$ck_loc=$dbc->query($u);
				if ($ck_loc->num_rows){
				...
				//$dbc->autocommit(FALSE);
					...
					if ($dbc->query($u) === TRUE) {
					   // $updated=TRUE;
					    echo '<p style="color:blue;font-weight:bold;text-align:center;font-size:1cm">Location has been deleted</p>
					    <br></br><p></p><span style="color:blue;font-weight:bold;padding-left:35px;padding-right:15px"><a href="sampletx.php">Home</a></span>';
...
print '
<form action="del_loc.php" method="post">
			<p style="text-align:center;font-size:28px;color:red;font-weight:bold;">Delete Location</p>
