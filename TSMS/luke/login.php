...
if ($loggedin) {
	...
	<p><div><div><div><div><label>Email Address <input type="email" name="email"></label></div></div></div></div></p>
	<p><div><label>Password <input type="password" name="password"></label></div></p>
	<p><div><input type="submit" name="submit" value="Log In!"></div></p>
	</form>';
