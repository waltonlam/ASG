...
{
	if (!empty($_POST['gid']) and !empty($_POST['gname']))	
		{
				$u= "update eleg set "
				."gcde='".$_POST['gid']."',gname='".$_POST['gname']."',avg_tp='".$_POST['gavtp']."'"
				." where gcde='".$_POST['gid']."';";
				...
				//$dbc->autocommit(FALSE);
					...
					if ($dbc->query($u) === TRUE) {
					   // $updated=TRUE;
					    echo '<p style="color:blue;font-weight:bold;text-align:center;font-size:1cm">Parameter Group has been updated</p>
...
print '
<form action="update_gp_m.php" method="post">
...
print '<tr style="color:#555555;">
				<td style="width:48%;text-align:right">	
					<label for="lid">Group Code</label>	  				
					<td>
...
print '</td></tr>			
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
				  <label for="gname">Average Type</label>
				</td>				  				
				<td>  
