...
{
	if (isset($_POST['did']) and isset($_POST['sid']) and isset($_POST['sname']) and isset($_POST['s_addr']))		
		{
				$u= "update station set "
				."district_id='".$_POST['did']."',name='".$_POST['sname']."',address='".$_POST['s_addr']."'"
				." where station_id='".$_POST['sid']."';";
				...
				//$dbc->autocommit(FALSE);
					...
					if ($dbc->query($u) === TRUE) {
					   // $updated=TRUE;
					    ...
					    <br></br><p></p><span style="color:blue;font-weight:bold;padding-left:35px;padding-right:15px"><a href="home.php">Home</a></span><span style="color:blue;font-weight:bold;padding-left:15px;padding-right:15px"><a href="station_m.php">Back</a></span>';
...
*/							
print '
<form action="update_st_m.php" method="post">
...
print '</td></tr>
			<tr style="color:#555555;">
				...
				<td>  
					<input style="margin-left:10px" type="text" name="sid" id="sid" readonly value="'.$t[1].'"></input>
</td></tr>			
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
				...
				<td>  
				  <input style="margin-left:10px" type="text" name="sname" id="sname" required value="'.$t[2].'"></input>
				</td>				  				
			</tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
				...
				<td>  
				  <input style="margin-left:10px" type="text" name="s_addr" id="s_addr" required value="'.$t[3].'"></input>
		</td>				  				
			</tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
