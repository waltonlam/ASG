...
{
	if (!empty($_POST['did']) and !empty($_POST['hse_id']) and !empty($_POST['hse_name']) and !empty($_POST['hse_type_id']) and !empty($_POST['hse_addr']))	
...
*/
		//and isset($_POST['did']) 
			$q = "insert into housing (district_id,house_id,house_type_id,name,address) 
						values ('".$_POST['did']."','".$_POST['hse_id']."','".$_POST['hse_type_id']."','".$_POST['hse_name']."','".$_POST['hse_addr']."');";
...
print '
<form onsubmit="submitForm()" action="hse_addnew.php" method="post">
			<p style="text-align:center;font-size:28px;color:blue;font-weight:bold;">新增屋苑/機構</p>
...
print '</td></tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
					<label for="hse_id">屋苑/機構(編號)</label>
				</td>
				<td>
				  <input style="margin-left:10px" type="text" name="hse_id" id="hse_id"></input>
				</td>				 	
			</tr>
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
					<label for="hse_name">屋苑/機構(名稱)</label>
				</td>
				<td>
				  <input style="margin-left:10px" type="text" name="hse_name" id="hse_name"></input>
				</td>				 	
			</tr>			
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
				...
				<td>
				  ...
				  <select style="margin-left:10px" name="hse_type_id">';
				    ...
				    print '<option value="'.$r_hse->house_type_id.'">'.'('.$r_hse->house_type_id.') '.$r_hse->name.'</option>';
				  }			
				
print	'</td>								
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
					<label for="hse_addr">地址</label>
				</td>   
				<td>  
					<textarea rows="4" cols="50" style="margin-left:10px" name="hse_addr" id="hse_addr"></textarea> 
				</td>				 	
			</tr>		
			<tr style="color:#555555;">
				<td style="width:48%;text-align:right">
...
*/
print'
  <span style="color:blue;font-weight:bold;padding-left:35px;padding-right:15px"><a href="home.php">Home</a></span><span style="color:blue;font-weight:bold;padding-left:15px;padding-right:15px"><a href="house_m.php">Back</a></span>
';
	...
	if ($comp=="false"){
			print '<p align="center" class="text--error">請確保所有資料均已輸入!</p>';
						...
						if ($created===TRUE){					
				echo '<p align="center" style="color:blue;font-weight:bold;font-size:28px">新增屋苑/機構成功</p>';}
					}
