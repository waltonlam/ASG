	...
	//*********Create T**************/	
		...
		for($i = 0; $i < count($_POST['id']); $i++) {			
			...
			$d.=$rn1.$i.";".$T.$i." Select loc_id,sample_date,m_time,sample_v as '".$_POST['id'][$i]
				."',unt as `".$_POST['id'][$i].".unt` From sample_ele where ".$loc_id." ele_id='".$_POST['id'][$i]."' and sample_date between '".$_POST['frm_date']."' and '".$_POST['to_date']."'; ";
			//$d.=$z;
		};		
	//=========Create T===============/	
	...
	//*****Restrcture Left&Right************
		...
		if (count($_POST['id']) > 1){
			...
			$J="create table A".$_SESSION['o'].$i." select T".$_SESSION['o'].$i.".loc_id,T".$_SESSION['o'].$i."
				.sample_date,T".$_SESSION['o'].$i.".m_time,T".$_SESSION['o'].$i.".`".$_POST['id'][$i]."`,T".$_SESSION['o'].$i.".`".$_POST['id'][$i].".unt`";
			...
			//If ($i++ <= count($_POST['id'])){
				$J .= ",T".$_SESSION['o'].($i+1).".`".$_POST['id'][($i+1)]."`,T".$_SESSION['o'].($i+1).".`".$_POST['id'][$i+1].".unt`";
			//}
			...
			$J .= "union select T".$_SESSION['o'].($i+1).".loc_id,T".$_SESSION['o'].($i+1)."
					.sample_date,T".$_SESSION['o'].($i+1).".m_time,T".$_SESSION['o'].$i.".`".$_POST['id'][$i]."`,T".$_SESSION['o'].$i.".`".$_POST['id'][$i].".unt`";
			...
			for($i = 1; $i < count($_POST['id'])-1; $i++) {		
				...
				for ($e = 0; $e <= $i; $e++) {
					$J .= ",A".$_SESSION['o'].($i-1).".`".$_POST['id'][$e]."`,A".$_SESSION['o'].($i-1).".`".$_POST['id'][$e].".unt`";
				}
				...
				for ($s = 0; $s <= $i; $s++) {
					$J .= ",A".$_SESSION['o'].($i-1).".`".$_POST['id'][$s]."`,A".$_SESSION['o'].($i-1).".`".$_POST['id'][$s].".unt`";
				}
			...
			" Select loc_id,sample_date,m_time,sample_v as '".$_POST['id'][$i]
				."',unt From sample_ele where ".$loc_id." ele_id='".$_POST['id'][$i]."' and sample_date between '".$_POST['frm_date']."' and '".$_POST['to_date']."'; ";			
		}
		...
		if ($dbc->multi_query($d)) {
			...
			header("Location:http://127.0.0.1/tsms_office20190911/templates/exp.php"); 
