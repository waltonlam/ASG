       ...
       $total_samples=substr_count($sid_lst," ");
        for ($e = 0; $e<=$total_samples; $e++)  {
            ...
            $sid_lst = substr($sid_lst,$spc+1);
                ...
                $sid_lst = substr($name,13); 
        echo "sid_lst = $sid_lst<br>";
        $sid_cnt=substr_count($sid_lst," ");
        $sample_line_id=0;
        $sample_line_id=$SampleID_line_key+2;
        echo "sample_line_id = $sample_line_id<br>";
        for ($e = 0; $e<=$sid_cnt; $e++)  {
            echo "lines[$sample_line_id] = $lines[$sample_line_id]<br>";
...
<body>
    ...
    <div class="outer-scontainer">
        <div class="row">
            ...
            <form class="form-horizontal" action="dix_df_conv.php" method="post"
                name="frmJPGImport" id="frmJPGImport"
                enctype="multipart/form-data">
                <div class="input-row">
                    <label class="col-md-4 control-label">Choose <b>Dioxins DF Group</b> JPEG File (.jpg)</label>
                    <br />
