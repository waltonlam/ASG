...
if(substr($result[0]["sample_id"],5,1) == 'F'){
	$yearFieldBlankAvg = $compoundModel->calAvgFieldBlank($result[0]["compound_grp"], substr($result[0]["sample_id"],6,2));
		...
		<div>
			...
			<form action="?id=<?php echo $result[0]['id']; ?>" method="post" name="frm-edit" enctype="multipart/form-data">
				<table>
					...
					<tr>	
						<td style="width: 160px; vertical-align: top;">Yearly Field Blank Average: </td>
						<td>
							<input type="text" name="compound_grp" value="<?php echo $yearFieldBlankAvg[0]["avg_ppbv"]?>" />
						</td>
					</tr>
