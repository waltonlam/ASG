...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		foreach($returnVal as $key => $result) {
			...
			$in= "update glab_template set "
					."conc='".$concInt."' , conc_string ='".$conc. "' , compound_code = '".$compoundCode.""."' ,start_date = '".$m."' , casno1 ='".$casno1."' , glab_result = '".$glab_result."' ,	raw_result = '".$raw_result."'".
					" where sample_id ='".$simpleID."'
					AND casno1 ='".$casno1 ."';";
