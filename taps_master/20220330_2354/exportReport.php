...
<h2>Export GLab Report</h2>
    ...
    <form class="form-horizontal" action="function.php" name="upload_excel"  onsubmit="return validateForm()" 
								...
								<table  width= "100%">
									...
									<tr>
										...
										<td>
											...
											<label><input type="checkbox" style="margin-left:30px;"   id="unselectAllCb" onclick="unselectAllClickEvent()">
											Unselect All</label>
