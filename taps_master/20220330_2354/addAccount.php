...
?>
 ...
 <h2>Add New Account</h2>
  <body>
<div id="main-content"><br><form action="addAccount.php" method="post"><table><tr>
 ...
 <td>		
            ...
            <input style="margin-left:10px" type="text" name="pwd" required></td></tr><tr><td>
			<label>First name</label></td><td>
            <input style="margin-left:10px" type="text" name="fname"></td></tr><tr><td>
			<label>Last name</label></td><td>
            <input style="margin-left:10px" type="text" name="lname"> </td></tr><tr><td>
			<label>Read only</label></td><td>
            <input style="margin-left:10px" type="checkbox" name="ronly"></td></tr><tr><td></td><td>
        <input  style="margin-left:10px"  class="submit" type="submit" value="Add"  /></td></tr>
		</table></form><br></div>
<?php
if ($uid<>''){ 
