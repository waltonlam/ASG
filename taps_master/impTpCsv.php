			...
			if ($rowcount == 0) {
				if (!empty($sampleId)){
					...
					if (!empty($res)) {
						$r_in++;
						$type = "success";
						$message = "*No. of TP records have been imported : ".$r_in;
					} else {
						$type = "error";
				...
				$count_duplicate++;
				$type = "error";
				$message = "*No. of TP records are duplicated : ".$count_duplicate;
			}
		}
...
<html>
	...
	<body>
		<h2 style="margin-left:10px">Import Toxaphene CSV File</h2><hr>
		<div id="response"
