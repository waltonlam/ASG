			...
			$val_list ="";
			 // if(!empty($_POST["compound_id"])){
			   ...
			   if (empty($compound_sub)) {
			   	...
			   	$sql_value.=" glab_template.compound_code IN (".$compound_sub.")";
			   	$sql_value.=" AND";
			   ...
			   if (empty($site_sub)) {
			    ...
			    $sql_value.=" glab_template.site IN (".$site_sub.")";
			    $sql_value.=" AND";
				$sql_value.=" glab_template.start_date between '".$_POST['start']."' and '".$_POST['end']."'";
			   ...
			   // }
				...
				?>
					...
					if (!empty($glabResult_array['result'])) {
						...
						foreach ($glabResult_array['result'] as $order): ?>
						  <tr>
						    ...
						    <td><?php echo $order['Conc./SAMPLE'] ?></td>

						    <td><?php echo $order['Flow(LPM)'] ?></td>
						    <td><?php echo $order['Time(min)'] ?></td>
						    <td><?php echo round($order['Volume(m3)'],5) ?></td>

						    <td><?php echo round($order['Conc/M3'],5) ?></td>
						    <td><?php echo $order['WHO_TEF Ratio'] ?></td>
						    <td><?php echo round($order['WHO_TEQ conc/m3'],5) ?></td>
						    <td><?php echo $order['casno1'] ?></td>
					...
					<button type="submit"  class="button button1" style="margin-top: 15px;" id="reviewPlotBtn" >Export</button> 
				...
				<div id="popup">
				    ...
				    <div id="popupContent">
				        ...
				        <p class="popupTitle">Compound: </p>
				        <input type="text" id="compound_value" >
				        <p class="popupTitle">Conc./SAMPLE: </p>
				        <input type="text"  id="conc_value"   >
				        <p class="popupTitle">Flow(LPM): </p>
				        <input type="text"  id="flow_value"  >
				        <p class="popupTitle">Time(min): </p>
